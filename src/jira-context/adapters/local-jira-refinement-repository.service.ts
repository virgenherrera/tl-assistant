...
function renderAgentPromptMarkdown(evidence: JiraRefinementEvidence): string {
  return [
    ...
    '## Frida VS Code mode',
    '',
    'Estás corriendo dentro de VS Code con la extensión aprobada `FridaPlatform.fridagpt`.',
    '',
    'No asumas MCP, terminal, Jira directo, browser, herramientas externas ni permisos fuera del workspace.',
    'Trabajá file-first con los artifacts locales que ya existen.',
    '',
    'Primero abrí y leé en este orden:',
    '',
    '1. `evidence.json`.',
    '2. `refinement.md`.',
    '3. Todos los archivos en `sources/`, si existen.',
    '',
    'Si necesitás más contexto, pedile al usuario un archivo, path local o source adicional. No inventes ni cambies de objetivo.',
    '',
    '## Archivos obligatorios',
    '',
    '1. `evidence.json` — evidencia estructurada Jira + sources.',
    '2. `refinement.md` — plantilla de salida con “qué pegar y dónde”.',
    '3. `sources/*` — contratos, notas, OpenAPI/Swagger o documentos extra copiados por el usuario.',
    '',
    '## Reglas anti-Frida',
    '',
