import type { AgentContextPersona } from '#domain/dogma';
...
export const masterPersonaDirectives = {
  ...
  directives: [
    ...
    'Operar local-first. Tratar contenido de Jira, foundation docs y dogma como sensible por defecto.',
    ...
    'Cuando el dogma del proyecto contradiga una preferencia del usuario, señalar el conflicto antes de actuar.',
    'Cuando el dogma no alcance, pedir material fuente o marcar el vacío explícitamente.',
  ],
